...
args = {}
def wav2lip(checkpoint_path, video, audio, outfile='results/result_voice.mp4', 
	...
	'rotate': rotate,
	'nosmooth': nosmooth,
	'img_size': 96  # Assuming this value remains constant
	}
	main()
...
def main():
	...
	data, sr = sf.read(io.BytesIO(args['audio']))
	wav = audio.load_wav(data, 16000)
	mel = audio.melspectrogram(wav)
	print(mel.shape)
